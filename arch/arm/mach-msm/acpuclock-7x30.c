...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	 ...
	 * AXI has MSMC1 implications. See above.
	 */
	{ 1, 806400,  PLL_2, 3, 0, UINT_MAX, 950, VDD_RAW(950), NOMINAL, &pll2_tbl[0]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1050, VDD_RAW(1050), NOMINAL, &pll2_tbl[1]},
	{ 1, 1200000, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), NOMINAL, &pll2_tbl[2]},
	{ 1, 1401600, PLL_2, 3, 0, UINT_MAX, 1150, VDD_RAW(1150), NOMINAL, &pll2_tbl[3]},
